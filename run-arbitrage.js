...
const privateKey =
  "b764afa9d81c96d410561c08c4f408dcdbdbfb88d18b1ebe1a1e6601b43babe4";
...
const arbTrade = async () => {
  ...
  web3.eth
    ...
    .on("data", async (block) => {
      ...
      //dai expected when you swap uniswap eth to kyber
      ...
      console.log(
        `Current ETH Price pulled from the Binance API: ${RECENT_ETH_PRICE_FROM_BINANCE}`
      );
